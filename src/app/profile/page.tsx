...
export default function ProfilePage() {
  ...
  const userProducts = user
    ? products.filter((p) => p.makerId === user.uid)
    : [];
          ...
          if (newListing.material && newListing.photoDataUri) {
            const newGivenItem: Material = {
              ...
              description:
                ...
                `A new listing for ${newListing.material}.`,
            ...
            setGivenItems((prevItems) => {
              if (
                prevItems.find((item) => item.imageUrl === newGivenItem.imageUrl)
              ) {
                return prevItems;
              }
  ...
  if (!user) {
    return (
       <div className="container mx-auto px-4 py-12 md:px-6 text-center">
        ...
        <h2 className="text-2xl font-bold font-headline">Please login to view your profile.</h2>
        <p className="text-muted-foreground mt-2">You need to be authenticated to access this page.</p>
  ...
  const profile = {
    ...
    bio: 'Your bio will appear here. You can edit it in your settings.', // Placeholder
    ...userData,
  };
        ...
        <CardContent className="pt-8">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-baseline">
                <p className="text-4xl font-bold text-primary">
                  {profile.impactScore} kg
                </p>
                <p className="text-sm text-muted-foreground">
                  of waste diverted from landfills
                </p>
              </div>
              <Progress value={profile.impactScore} max={50} className="h-3" />
              <p className="text-xs text-muted-foreground text-center">
                You're on your way to becoming an Eco-Champion! Next goal: 50kg.
              </p>
            </CardContent>
          </Card>
          ...
          <Tabs defaultValue="creations" className="mt-8">
              ...
              {givenItems.length === 0 ? (
                <div className="text-center py-16">
                  <p className="text-muted-foreground">
                    You haven't listed any items to give away yet.
                  </p>
            ...
            <TabsContent value="leaderboard" className="mt-6 text-center py-16">
              ...
              <p className="text-muted-foreground">
                Compete with others to see who can make the biggest impact.
              </p>
            </TabsContent>
          </Tabs>
        </CardContent>
